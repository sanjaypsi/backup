...
func (poi *PublishOperationInfo) ListLatestAssetDocuments(
	...
	fmt.Printf(" Debug Info - sortBy: %s, sortDir: %d\n", sortBy, sortDir)

	// 🔥 Build final pipeline properly
