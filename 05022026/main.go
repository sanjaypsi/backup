...
// clampPerPage ensures perPage is within a reasonable range (e.g., 1 to 100)
...
func main() {
	...
	apiRouter := router.Group("/api")
	{
		...
		// ===========================================================================================
		// == Add by SanjayK ==
		// Assets Pivot2 API - returns latest review info per asset
		// ===========================================================================================
		...
		if os.Getenv("PPI_MONGODB_USER") == "central30_dev" {
			func() {
